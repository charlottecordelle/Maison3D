...
export class AppComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    mur2.position.set(2.5, hauteur/2, 8);
    houseGroup.add(mur2)
    ...
    mur3.position.set(5, hauteur/2, 0);
    houseGroup.add(mur3)

    const mur4Geo = new THREE.BoxGeometry(longueur2, hauteur, largeur);
    const mur4Material = new THREE.MeshBasicMaterial({ color:'gray' });
    const mur4 = new THREE.Mesh(mur4Geo, mur4Material);
    mur4.position.set(2.5, hauteur/2, 0);
    houseGroup.add(mur4)
